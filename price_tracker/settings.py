...
SECRET_KEY = 'django-insecure-=r5j2+=7omf)orf&)bzm2&=mvduel)rtkhb#l!%7c4&)jl&*!r'
...
INSTALLED_APPS = [
    'tracker',  # Your app for tracking prices
...
CELERY_RESULT_BACKEND = 'redis://redis:6379/0' # We will use Redis for results
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'